...
<br>
 ...
 I will be using Windows Server 2022 as my server to control different PCs with other VMs using Active Directory. Go to the <a href="https://www.microsoft.com/en-us/evalcenter" target="_blank"> Microsoft Evaluation Center<a/> site and click on Windows Server then Windows Server 2022. 
